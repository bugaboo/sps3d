C***********************************************************************
      PROGRAM MAIN
C
C  Differential cross section in SPS basis
C  Usage:
C  user@host$ diff_cs KJOB N [OSTR, FSTR]
C   KJOB: 1 - calculate only for phi = 0, 2 - full sphere
C   N is the number of points
C   OSTR is the direction of cross section: ox - along Ox, oy - along Oy, if ommited defaults to Oz
C   FSTR = -file means to look for eigenvalues and eigenvectors in files instead of computing
C***********************************************************************
      USE ANGSYM
