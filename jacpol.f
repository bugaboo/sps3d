      SUBROUTINE JACPOM(A,B,NMAX)
C=======================================================================
C  NORMALIZED JACOBI POLYNOMIALS 
C-----------------------------------------------------------------------
      IMPLICIT REAL*8(A-H,O-Z)
      PARAMETER(NDIM=999)
      DIMENSION P1(2:NDIM),P2(2:NDIM),P3(2:NDIM),PL(0:*)
      SAVE C0,C1,C2,P1,P2,P3
C
      IF(NMAX.GT.NDIM) STOP ' *** JACPOM DIMENSION ERROR'
      AB=A+B
C
